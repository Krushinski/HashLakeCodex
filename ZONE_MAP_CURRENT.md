...
Phase 120 keeps the single ordered zone table and treats the oldest cone/spike forest as placeholder art rather than final vegetation. Placement and zone ownership remain intact, but the rendering layer now demotes the simple proxy tree families and adds more asset-like native vegetation: mature alpine fir specimens for the shoreline/mid forest, mountain-base mixed spruce stands for Zone 5/6 climbing ecology, taller tower spruces, low understory evergreen patches, and a bounded native procedural alpha-pine silhouette layer for more tree-like far-forest texture. The ground ribbons also receive richer terrain texture: shore pocket dips, root-mat darkening, conifer duff, forest rise veins, root buttress ridges, meadow flecks, hummocks, and woodland shelves. The intent remains foreground, middle ground, background, mountain base, with stronger 3D terrain character instead of flat paper bands or toy-cone dominance.
